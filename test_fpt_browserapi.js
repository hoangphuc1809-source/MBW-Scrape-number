...
(async () => {
  ...
  try {
    ...
    // Da thu chan image/font/media de tiet kiem bang thong nhung lam hong
    // co che lazy-load cua FPT (nut "Xem them" phu thuoc anh tai xong) -> bo,
    // giu nguyen tai day du nhu browser that.
